     ...
     <div id="project" className="project">
         <div className="container">
           ...
           <div className="titlepage" >
                     <h2 style={{backgroundColor:'#EBBF60'}}>Popular Brands</h2>
            </div>
            ...
            <div className="row mt-5">
               <div className="col-md-12">
                  <div className="titlepage" >
                     <h2 style={{backgroundColor:'#EBBF60'}}>Featured Products</h2>
                  </div>
               </div>
            </div>
            ...
            {productList.map((product, index) => <div key={index} className="col-md-4 col-lg-4 col-sm-4">
                  ...
                  <h2 style={{ cursor: 'pointer' }} className="mt-2 mb-4 font-weight-bold text-center text-dark">Product Description</h2>
                  <div style={{ height: "40px" }}>
                     <div style={{ width: "50%", height: "100%", float: "left", }} className="btn btn-outline-warning">Favorite</div>
                     <div onClick={()=>addToCart(product)} style={{ width: "50%", height: "100%", float: 'right', backgroundColor: '#343a40' }} className="btn text-white">Add To Cart</div>
                  </div>
               </div>)}
