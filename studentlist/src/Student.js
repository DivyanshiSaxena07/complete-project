...
render(){
  return<div className='container bg-light'>
    <div className='text-center' style={{backgroundColor:'#dc3545',color:'white'}}><h1>Student Record</h1></div>
  ...
  <div className='row mt-3'>
    <div className='col md-6'>
      <label>Branch:</label>
      <select  className='form-control'value={this.state.branch} onChange={(e)=>{this.setState({branch:e.target.value})}}>
  ...
  {/* four row------------------------------- */}
  <div className='row mt-5' style={{backgroundColor:'whitesmoke'}}>
