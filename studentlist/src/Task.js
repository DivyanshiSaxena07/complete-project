...
render(){
  ...
  <div className='row mt-3'>
        <div className='col md-6'>
          ...
          <div className='col md-6'>
          <label>Roll No:</label>
            <input type='number' required className='form-control'  onKeyUp={(e)=>{
              let len=this.state.studentData.filter((student)=>{
                return  student.roll==this.state.roll}).length;
               if(len){
                 this.setState({
  ...
  <div className='row mt-3'>
    <div className='col md-6'>
      <button type='submit' disabled={this.state.warning} className='btn btn-success' onClick={this.add}>Add</button>
    </div>
    <div className='col md-6'>
